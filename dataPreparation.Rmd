...
=======
#Creating csv file from the merged data
write_csv(weatherES, "D:\\SyracuseUniversity\\Semester1\\IST_687-IntroToDataScience\\IST687-FinalProject\\weatherES.csv")
>>>>>>> 96122b23396cd4b0a88376d4a4693ce5092fd140
```
...
```{r}
weekWeather <- aggregate(total ~wday(time) + in.county, data=aggEnergy, FUN = sum, na.rm = TRUE)
```
